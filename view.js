...
function displayMaze(mazeInfo) {
    ...
    gridElement.style.setProperty("grid-template-columns", `repeat(${mazeInfo.cols}, max-content)`);
    gridElement.style.setProperty("grid-template-rows", `repeat(${mazeInfo.rows}, max-content)`);
